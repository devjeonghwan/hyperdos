...
typedef struct hyperdos_pc_video_bios_interface
{
    ...
    void (*writeString)(hyperdos_x86_processor* processor,
                        void*                   userContext,
                        uint8_t                 writeMode,
                        uint8_t                 videoPage,
                        uint8_t                 attribute,
                        ...
                        uint16_t                row,
                        uint16_t                column);
    void (*writeFunctionalityStateTable)(hyperdos_x86_processor* processor, void* userContext);
    uint16_t (*getSaveRestoreStateBufferBlocks)(uint16_t requestedState);
    int (*writeSaveRestoreState)(hyperdos_x86_processor* processor,
                                 void*                   userContext,
                                 uint16_t                requestedState,
                                 uint16_t                bufferOffset);
    int (*restoreSaveRestoreState)(hyperdos_x86_processor* processor,
                                   void*                   userContext,
                                   uint16_t                requestedState,
                                   uint16_t                bufferOffset);
    ...
    int (*writeRegisterInterfaceRegister)(void*    userContext,
                                          ...
                                          uint8_t  registerNumber,
                                          uint8_t  registerValue);
    void (*writeKoreanExtensionPlaceholderCharacterShape)(hyperdos_x86_processor* processor,
                                                          void*                   userContext,
                                                          uint16_t                bufferOffset);
